...
IFontDisp = Font
__all__ = [ 'FONTBOLD', 'Checked', 'OLE_XSIZE_HIMETRIC',
           'OLE_YPOS_CONTAINER', 'FONTITALIC', 'StdPicture',
           'IPictureDisp', 'OLE_TRISTATE', 'OLE_XSIZE_CONTAINER',
           'IFontEventsDisp', 'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_PIXELS',
           'LoadPictureConstants', 'OLE_COLOR', 'OLE_XPOS_HIMETRIC',
           'Font', 'OLE_YPOS_HIMETRIC', 'OLE_CANCELBOOL', 'IPicture',
           'Color', 'OLE_XPOS_PIXELS', 'StdFont',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XPOS_CONTAINER',
           'FontEvents', 'FONTUNDERSCORE', 'FONTSTRIKETHROUGH',
           'IFont', 'FONTNAME', 'VgaColor', 'OLE_XSIZE_PIXELS',
           'Default', 'OLE_YSIZE_PIXELS', 'Unchecked', 'Monochrome',
           'Picture', 'FONTSIZE', 'Gray', 'IFontDisp', 'OLE_HANDLE',
